...
it('Update tickets with authorization', function () {
	...
	DB::insert("insert into tickets
	 (id,   ticketable_type, ticketable_id, name, email,    user_id, assigned_to_id, status, priority,      title,     content,   created_at, updated_at) values
	  (1,              null,          null, null,  null, $userA->id,           null,      0,        0, 'Ticket 1', 'Content 1', '2022-10-10 00:00:00', '2022-10-10 00:00:00'),
	  (2, 'App\Models\Item',             1, null,  null, $userA->id,   $manager->id,      0,        0, 'Ticket 2', 'Content 2', '2022-10-10 00:00:00', '2022-10-10 00:00:00'),
	  (3, 'App\Models\Item',             1, null,  null, $userB->id,  $supportA->id,      3,        0, 'Ticket 3', 'Content 3', '2022-10-10 00:00:00', '2022-10-10 00:00:00'),
	  (4, 'App\Models\Item',             2, null,  null, $userB->id,  $supportB->id,      2,        0, 'Ticket 4', 'Content 4', '2022-10-10 00:00:00', '2022-10-10 00:00:00');
	");
